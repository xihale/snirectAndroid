...
object AppIcons {
    ...
    val Language: ImageVector
        get() = materialIcon(name = "Filled.Language") {
            path(fill = SolidColor(Color.Black)) {
                moveTo(11.99f, 2.0f)
                ...
                curveToRelative(-0.33f, -1.42f, -0.87f, -2.85f, -1.54f, -4.21f)
                curveTo(16.34f, 4.67f, 18.05f, 6.09f, 18.91f, 8.0f)
                close()
                moveTo(12.0f, 4.04f)
                curveToRelative(0.73f, 1.24f, 1.34f, 2.59f, 1.63f, 3.96f)
                horizontalLineToRelative(-3.26f)
                curveToRelative(0.29f, -1.37f, 0.9f, -2.72f, 1.63f, -3.96f)
                close()
                moveTo(3.55f, 14.0f)
                curveTo(3.2f, 13.36f, 3.0f, 12.69f, 3.0f, 12.0f)
                reflectiveCurveToRelative(0.2f, -1.36f, 0.55f, -2.0f)
                horizontalLineToRelative(3.53f)
                curveToRelative(-0.06f, 0.66f, -0.1f, 1.32f, -0.1f, 2.0f)
                reflectiveCurveToRelative(0.04f, 1.34f, 0.1f, 2.0f)
                horizontalLineTo(3.55f)
                close()
                moveTo(4.46f, 16.0f)
                horizontalLineToRelative(3.08f)
                curveToRelative(0.33f, 1.42f, 0.87f, 2.85f, 1.54f, 4.21f)
                curveTo(7.66f, 19.33f, 5.95f, 17.91f, 4.46f, 16.0f)
                close()
                moveTo(7.54f, 8.0f)
                horizontalLineTo(4.46f)
                curveToRelative(1.49f, -1.91f, 3.2f, -3.33f, 4.83f, -4.21f)
                curveTo(8.67f, 5.15f, 8.13f, 6.58f, 7.8f, 8.0f)
                close()
                moveTo(12.0f, 19.96f)
                curveToRelative(-0.73f, -1.24f, -1.34f, -2.59f, -1.63f, -3.96f)
                horizontalLineToRelative(3.26f)
                ...
                curveToRelative(-0.07f, -0.66f, -0.11f, -1.33f, -0.11f, -2.0f)
                reflectiveCurveToRelative(0.04f, -1.34f, 0.11f, -2.0f)
                horizontalLineToRelative(4.94f)
                curveToRelative(0.07f, 0.66f, 0.11f, 1.34f, 0.11f, 2.0f)
                reflectiveCurveToRelative(-0.04f, 1.34f, -0.11f, 2.0f)
                close()
                moveTo(15.92f, 14.0f)
                curveToRelative(0.06f, -0.66f, 0.1f, -1.34f, 0.1f, -2.0f)
                reflectiveCurveToRelative(-0.04f, -1.34f, -0.1f, -2.0f)
                horizontalLineToRelative(3.53f)
                curveToRelative(0.35f, 0.64f, 0.55f, 1.31f, 0.55f, 2.0f)
                reflectiveCurveToRelative(-0.2f, 1.36f, -0.55f, 2.0f)
                horizontalLineToRelative(-3.53f)
                close()
                moveTo(14.54f, 20.21f)
                curveToRelative(0.67f, -1.36f, 1.21f, -2.79f, 1.54f, -4.21f)
                horizontalLineToRelative(3.08f)
                curveTo(18.29f, 17.91f, 16.58f, 19.33f, 14.54f, 20.21f)
                close()
            }
        }
}